...
const Coverage = () => {
    ...
    return (
        <div>
            <h className="text-5xl font-bold">We Are Available In 64 Districts</h>
            ...
            <div className='border w-full h-[480px]'>
                <MapContainer
                    center={position}
                    zoom={8}
                ...
                >
...

                    {
                        serviceCenter.map((center, index) => <Marker
                            ...
                            <Popup>
                                <strong>{center.district}</strong> <br /> Service Ares: {center.covered_area.join(', ')}
                            </Popup>
                        </Marker>
                        )
                    }
